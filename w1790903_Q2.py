...
class notDefinedCharacter(
    Exception):  # Exception to be raised if the user enters any other character than p or q during the input section to termiante loop
    pass
        ...
        try:
            ...
            while validFlag == False:
                try:
                    ...
                    if (passCredit == 0) or (passCredit == 20) or (passCredit == 40) or (passCredit == 60) or (
                            passCredit == 80) or (passCredit == 100) or (passCredit == 120):
                        validFlag = True
                    else:
            ...
            while validFlag == False:
                try:
                    ...
                    # Checking whether the entered passCredit value is acceptable
                    if (deferCredit == 0) or (deferCredit == 20) or (deferCredit == 40) or (deferCredit == 60) or (
                            deferCredit == 80) or (deferCredit == 100) or (deferCredit == 120):
                        validFlag = True
                    else:
                        raise notAcceptable()
                        validFlag = False
            ...
            while validFlag == False:
                try:
                    ...
                    # Checking whether the entered passCredit value is acceptable
                    if (failCredit == 0) or (failCredit == 20) or (failCredit == 40) or (failCredit == 60) or (
                            failCredit == 80) or (failCredit == 100) or (failCredit == 120):
                        validFlag = True
                    else:
                        raise notAcceptable()
                        validFlag = False
...
if runOrQuit == "q":
    ...
    print("Progress", progressCounter, "  :    ", end="")
    for progressForCounter in range(1, (progressCounter + 1)):
        print("*", end="")
    print("\n")
    print("Trailing", trailingCounter, "  :    ", end="")
    for trailingForCounter in range(1, (trailingCounter + 1)):
        print("*", end="")
    print("\n")
    print("Retriever", retrieverCounter, " :    ", end="")
    for retrieverForCounter in range(1, (retrieverCounter + 1)):
        print("*", end="")
    print("\n")
    print("Excluded", excludedCounter, "  :    ", end="")
    for excludedForCounter in range(1, (excludedCounter + 1)):
        print("*", end="")
    print("\n")
    print(studentCounter - 1, "outcomes in total")
